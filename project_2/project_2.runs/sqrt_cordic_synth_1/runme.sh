...
HD_PWD='/home/fpga14/fpga_14_all/project_2/project_2.runs/sqrt_cordic_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrt_cordic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sqrt_cordic.tcl
