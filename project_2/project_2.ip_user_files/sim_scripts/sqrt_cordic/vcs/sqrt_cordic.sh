...
design_libs=(xpm xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 axi_utils_v2_0_6 cordic_v6_0_19 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work cordic_v6_0_19 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sqrt_cordic xil_defaultlib.glbl -o sqrt_cordic_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sqrt_cordic_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fpga14/fpga_14_all/project_2/project_2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key sqrt_cordic_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sqrt_cordic_simv.daidir vcs_lib c.obj)
