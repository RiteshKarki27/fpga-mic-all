...
#
# Script generated by Vivado on Wed Apr 30 18:02:43 CEST 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : sqrt_cordic.sh
...
#
# Usage        : sqrt_cordic.sh
#                sqrt_cordic.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sqrt_cordic.sh [-reset_run]
#                sqrt_cordic.sh [-reset_log]
#                sqrt_cordic.sh [-help]
#
...
#                script (type 'sqrt_cordic.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_10 -libname c_reg_fd_v12_0_6 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_pipe_v3_0_6 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_addsub_v3_0_6 -libname c_addsub_v12_0_15 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname axi_utils_v2_0_6 -libname cordic_v6_0_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 axi_utils_v2_0_6 cordic_v6_0_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "sqrt_cordic.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sqrt_cordic.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work cordic_v6_0_19 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sqrt_cordic xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sqrt_cordic -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fpga14/fpga_14_all/project_2/project_2.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sqrt_cordic_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sqrt_cordic.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sqrt_cordic.sh [-help]\n\
Usage: sqrt_cordic.sh [-step]\n\
Usage: sqrt_cordic.sh [-lib_map_path]\n\
Usage: sqrt_cordic.sh [-reset_run]\n\
Usage: sqrt_cordic.sh [-reset_log]\n\
Usage: sqrt_cordic.sh [-keep_index]\n\
Usage: sqrt_cordic.sh [-noclean_files]\n\n\
