...
#
# Script generated by Vivado on Wed Apr 23 16:45:27 CEST 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : jtag_axi_0.sh
...
#
# Usage        : jtag_axi_0.sh
#                jtag_axi_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                jtag_axi_0.sh [-reset_run]
#                jtag_axi_0.sh [-reset_log]
#                jtag_axi_0.sh [-help]
#
...
#                script (type 'jtag_axi_0.sh -help' for more information).
#
...
# script info
echo -e "jtag_axi_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./jtag_axi_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../project_fpga.gen/sources_1/ip/jtag_axi_0/hdl/verilog" \
  ...
  vlogan -work jtag_axi $vlogan_opts +v2k +incdir+"../../../../project_fpga.gen/sources_1/ip/jtag_axi_0/hdl/verilog" \
  "../../../ipstatic/hdl/jtag_axi_v1_2_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_fpga.gen/sources_1/ip/jtag_axi_0/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.jtag_axi_0 xil_defaultlib.glbl -o jtag_axi_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./jtag_axi_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key jtag_axi_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc jtag_axi_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./jtag_axi_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: jtag_axi_0.sh [-help]\n\
Usage: jtag_axi_0.sh [-step]\n\
Usage: jtag_axi_0.sh [-lib_map_path]\n\
Usage: jtag_axi_0.sh [-reset_run]\n\
Usage: jtag_axi_0.sh [-reset_log]\n\
Usage: jtag_axi_0.sh [-keep_index]\n\
Usage: jtag_axi_0.sh [-noclean_files]\n\n\
