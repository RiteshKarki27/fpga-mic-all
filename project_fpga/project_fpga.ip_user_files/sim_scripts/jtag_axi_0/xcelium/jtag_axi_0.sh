...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../project_fpga.gen/sources_1/ip/jtag_axi_0/hdl/verilog" \
  ...
  xmvlog -work jtag_axi $xmvlog_opts +incdir+"../../../../project_fpga.gen/sources_1/ip/jtag_axi_0/hdl/verilog" \
  "../../../ipstatic/hdl/jtag_axi_v1_2_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../project_fpga.gen/sources_1/ip/jtag_axi_0/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.jtag_axi_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.jtag_axi_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log jtag_axi_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
