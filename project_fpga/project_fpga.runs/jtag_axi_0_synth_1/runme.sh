...
HD_PWD='/home/fpga14/project_fpga/project_fpga.runs/jtag_axi_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jtag_axi_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jtag_axi_0.tcl
